...
def generate_instance_dependent_candidate_labels(ds, train_loader, train_labels, device):
    if ds == 'cifar10':
        weight_path = '/home/zzf/CausalPLL/IPWC/data/weights/cifar10_400.pt'
        model = resnet(depth=32, num_classes=10)
        rate = 0.4
    elif ds == 'mnist':
        weight_path = '/home/zzf/CausalPLL/IPWC/data/weights/mnist_400.pt'
        model = mlp_model(input_dim=28*28, output_dim=10)
        rate = 0.4
    elif ds == 'kmnist':
        weight_path = '/home/zzf/CausalPLL/IPWC/data/weights/kmnist_400.pt'
        model = mlp_model(input_dim=28*28, output_dim=10)
        rate = 0.4
    elif ds == 'fmnist':
        weight_path = '/home/zzf/CausalPLL/IPWC/data/weights/fmnist_400.pt'
        model = mlp_model(input_dim=28*28, output_dim=10)
        rate = 0.4
    elif ds == 'cifar100':
        weight_path = '/home/qiaocy/data/IDGP/partial_weights/c100_resnext.pt'      # not found yet
        model = resnext(cardinality=16, depth=29, num_classes=100)
        rate = 0.04
    elif ds == 'cub200':
        weight_path = '/home/qiaocy/data/IDGP/partial_weights/cub200_256.pt'        # not found yet
        model = Resnet34(200)
        rate = 0.04
